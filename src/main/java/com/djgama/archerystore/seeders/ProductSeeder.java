...
//			try(Scanner scan = new Scanner(new File("src/main/resources/db/products-main.txt"))){
			while(scan.hasNext()){
...
//				}
				...
				Product product = persistProduct(line[0], line[1], category, line[3], line[4]);
			}
	...
	private Product persistProduct(String name, String price, Category category, String description, String imgLink){
		...
		return productServ.persistOne(newObject);
	}
}
